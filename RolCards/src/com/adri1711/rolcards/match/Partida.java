...
public class Partida
{
  ...
  public void turnoJugador1() {
    ...
    this.jugador1.getP().playSound(this.jugador1.getP().getLocation(), 
        Utils.buscaSonido("ARROW", "SHOOT"), 10.0F, 1.0F);
    this.jugador1.setTurn(true);
    this.jugador2.setTurn(false);
    this.jugador1.drawACard();
    if (this.plugin.getLanguage().equals("es")) {
      Utils.usaTitle(this.jugador1.getP(), ChatColor.GREEN + "Turno de", ChatColor.YELLOW + this.jugador1.getP().getName(), this.plugin);
      Utils.usaTitle(this.jugador2.getP(), ChatColor.GREEN + "Turno de", ChatColor.YELLOW + this.jugador1.getP().getName(), this.plugin);
    } else {
      Utils.usaTitle(this.jugador1.getP(), ChatColor.GREEN + this.message.getPlayerTurnOfMsg(), ChatColor.YELLOW + this.jugador1.getP().getName(), this.plugin);
      Utils.usaTitle(this.jugador2.getP(), ChatColor.GREEN + this.message.getPlayerTurnOfMsg(), ChatColor.YELLOW + this.jugador1.getP().getName(), this.plugin);
    } 
    ...
    this.sched = Bukkit.getServer().getScheduler().runTaskLater((Plugin)this.plugin, new Runnable() {
          public void run() {
            if (Partida.this.getNumTurnosPasados() == 0) {
              if (Partida.this.jugador1 != null && 
                Partida.this.jugador1.getPartida() != null) {
  ...
  public void turnoJugador2() {
    if (this.jugador1.getCartas().size() == 0 && this.jugador2.getCartas().size() == 0) {
      ...
      this.jugador2.getP().playSound(this.jugador2.getP().getLocation(), 
          Utils.buscaSonido("ARROW", "SHOOT"), 10.0F, 1.0F);
      ...
      if (this.plugin.getLanguage().equals("es")) {
        Utils.usaTitle(this.jugador1.getP(), ChatColor.GREEN + "Turno de", ChatColor.YELLOW + this.jugador2.getP().getName(), this.plugin);
        Utils.usaTitle(this.jugador2.getP(), ChatColor.GREEN + "Turno de", ChatColor.YELLOW + this.jugador2.getP().getName(), this.plugin);
      } else {
        Utils.usaTitle(this.jugador1.getP(), ChatColor.GREEN + this.message.getPlayerTurnOfMsg(), ChatColor.YELLOW + this.jugador2.getP().getName(), this.plugin);
        Utils.usaTitle(this.jugador2.getP(), ChatColor.GREEN + this.message.getPlayerTurnOfMsg(), ChatColor.YELLOW + this.jugador2.getP().getName(), this.plugin);
      } 
      if (this.plugin.isScoreboardEnabled()) {
        Utils.updateScoreboard(this.jugador1.getP(), this.jugador1, this.jugador2.getP().getName(), this.plugin);
        Utils.updateScoreboard(this.jugador2.getP(), this.jugador2, this.jugador2.getP().getName(), this.plugin);
      } 
      this.sched = Bukkit.getServer().getScheduler().runTaskLater((Plugin)this.plugin, new Runnable() {
            public void run() {
              if (Partida.this.getNumTurnosPasados() == 0) {
                if (Partida.this.jugador2 != null && 
                  Partida.this.jugador2.getPartida() != null) {
  ...
  private void deathMatch() {
    ...
    p1.playSound(p1.getLocation(), 
        Utils.buscaSonido2("EXPLODE", "ENTITY_GENERIC_EXPLODE"), 10.0F, 1.0F);
    p2.playSound(p2.getLocation(), 
        Utils.buscaSonido2("EXPLODE", "ENTITY_GENERIC_EXPLODE"), 10.0F, 1.0F);
  }


  
  public ArenaRC getArena() { return this.arena; }


  
  public void setArena(ArenaRC arena) { this.arena = arena; }
  ...
  public BukkitTask getSched() { return this.sched; }


  
  public void setSched(BukkitTask sched) { this.sched = sched; }
  ...
  public int getNumTurnosPasados() { return this.numTurnosPasados; }


  
  public void setNumTurnosPasados(int numTurnosPasados) { this.numTurnosPasados = numTurnosPasados; }
  ...
  public Jugador devuelveOtroJugador(Jugador j) {
    Jugador res = null;
    if (j.getP().getName() == this.jugador1.getP().getName()) {
      res = this.jugador2;
    } else if (j.getP().getName() == this.jugador2.getP().getName()) {
      res = this.jugador1;
    } 
    return res;
  }
