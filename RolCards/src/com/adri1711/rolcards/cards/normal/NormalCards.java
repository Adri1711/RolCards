...
public class NormalCards
{
  ...
  public NormalCards(RolCards plugin) {
    ...
    if (plugin.getLanguage().equalsIgnoreCase("es")) {
      this.flame = new Card(CardClass.NORMAL, "ßfßlLlamas", Integer.valueOf(0), Integer.valueOf(1), 
          "rolcards.class.normal", "ß7Envuelve a tu enemigo en llamas por 1 segundo");
      this.woodWeapon = new Card(CardClass.NORMAL, "ßfßlArma de Madera", Integer.valueOf(0), Integer.valueOf(1), 
          "rolcards.class.normal", "ß7Consigues una espada de madera");
      this.greatWeapon = new Card(CardClass.NORMAL, "ßfßlGran Arma", Integer.valueOf(0), Integer.valueOf(4), 
          "rolcards.class.normal", "ß7Consigues una espada de hierro");
      this.insectBite = new Card(CardClass.NORMAL, "ßfßlPicadura de Insecto", Integer.valueOf(0), Integer.valueOf(1), 
          "rolcards.class.normal", "ß7Ejerce 0.5 de da√±o al enemigo");
      this.tigerBite = new Card(CardClass.NORMAL, "ßfßlMordedura de Tigre", Integer.valueOf(0), Integer.valueOf(3), 
          "rolcards.class.normal", "ß7Ejerce 1 de da√±o al enemigo");
      this.bearScratch = new Card(CardClass.NORMAL, "ßfßlAra√±azo de Oso", Integer.valueOf(0), Integer.valueOf(4), 
          "rolcards.class.normal", "ß7Ejerce 1.5 de da√±o al enemigo");
      this.elephantStomp = new Card(CardClass.NORMAL, "ßfßlPisoton de Elefante", 
          Integer.valueOf(0), Integer.valueOf(7), "rolcards.class.normal", "ß7Ejerce 3 de da√±o al enemigo");
      this.manaSet = new Card(CardClass.NORMAL, "ßfßlSet de Mana", Integer.valueOf(0), Integer.valueOf(4), 
          "rolcards.class.normal", "ß7Pone tu mana a 5 por este turno");
      this.minorHealing = new Card(CardClass.NORMAL, "ßfßlPoca Cura", Integer.valueOf(0), 
          Integer.valueOf(2), "rolcards.class.normal", "ß7Te curas 1");
      this.majorHealing = new Card(CardClass.NORMAL, "ßfßlGran Cura", Integer.valueOf(0), 
          Integer.valueOf(4), "rolcards.class.normal", "ß7Te curas 2");
      this.equality = new Card(CardClass.NORMAL, "ßfßlIgualdad", Integer.valueOf(0), Integer.valueOf(8), 
          "rolcards.class.normal", "ß7Consigues la misma vida que tu oponente");
      this.shieldBearer = new Card(CardClass.NORMAL, "ßfßlEscudero", Integer.valueOf(0), 
          Integer.valueOf(3), "rolcards.class.normal", "ß7Consigues una pechera de cuero", 
          "ß7Te ayudara en ataques fisicos");
      this.incantation = new Card(CardClass.NORMAL, "ßfßlBrujeria", Integer.valueOf(0), Integer.valueOf(4), 
          "rolcards.class.normal", 
          "ß7Da√±a a tu enemigo 1 y te curas 0.5");
      this.takeARest = new Card(CardClass.NORMAL, "ßfßlDescanso", Integer.valueOf(0), Integer.valueOf(5), 
          "rolcards.class.normal", 
          "ß7Te curas 3 y acaba tu turno");
      this.presentForYou = new Card(CardClass.NORMAL, "ßfßlRegalito para ti", 
          Integer.valueOf(0), Integer.valueOf(9), "rolcards.class.normal", 
          "ß7Lanza una bomba al enemigo que da√±a 3.5");
      this.vampire = new Card(CardClass.NORMAL, "ßfßlVampiro", 
          Integer.valueOf(0), Integer.valueOf(4), "rolcards.class.normal", 
          "ß7Invoca un vampiro de 3 de ataque y 3 de salud");
      this.exiledZombie = new Card(CardClass.NORMAL, "ßfßlZombie Exiliado", 
          Integer.valueOf(0), Integer.valueOf(2), "rolcards.class.normal", 
          "ß7Invoca un zombie de 1 de ataque y 2 de salud");
    } else {
      ...
      this.shieldBearer = new Card(CardClass.NORMAL, message.getNormalShieldBearerMsg(), Integer.valueOf(0), 
          ...
          "ß7It can help you on physical attacks");
